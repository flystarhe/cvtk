...
from ._utils import _balance, _mask_top_by_grid, _rescale, _sorted_and_cat
...
def make_target(s, feats, bboxes, labels=None, topk=3, balance=False, use_sigmoid=False, eps=1e-2):
    ...
    for x1, y1, x2, y2, label in _sorted_and_cat(bboxes, labels):
        ...
        k = topk or 5  # the default value is grid of 5x5
        selected = _mask_top_by_grid(roi, k, eps)
