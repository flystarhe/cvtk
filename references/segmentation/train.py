...
def evaluate(model, data_loader, device, num_classes):
    ...
    with torch.no_grad():
        for image, target in metric_logger.log_every(data_loader, 100, header):
            ...
            _target = _transform(_output, target, img_shape, topk=1, balance=False)
...
def parse_args():
    ...
    parser.add_argument("--data-path", default="/workspace/coco", help="dataset path")
    ...
    parser.add_argument("--pretrained", action="store_true", help="pre-trained from modelzoo")
